...
/** This service provides the API for the user interface. The API endpoints correspond to methods on the Model. Data is sent over HTTP as
  * JSON.
  *
